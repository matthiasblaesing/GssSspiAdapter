...
/**
 * Implements the GSSNameSpi for the SSPI mechanism.
 *
 * @author Mayank Upadhyay
 */
public class SSPINameElement
    ...
    private SSPINameElement(PrincipalName principalName,
                            String gssNameStr,
                            Oid gssNameType) {
    ...
    /**
     * Instantiates a new SSPINameElement object. Internally it stores the
     ...
     *
     */
    static SSPINameElement getInstance(String gssNameStr, Oid gssNameType)
        throws GSSException {
         ...
         */
        if (gssNameType == null)
            gssNameType = GSSUtil.NT_GSS_KRB5_PRINCIPAL;
        else
            if (!gssNameType.equals(GSSName.NT_USER_NAME) &&
                !gssNameType.equals(GSSName.NT_HOSTBASED_SERVICE) &&
                !gssNameType.equals(GSSUtil.NT_GSS_KRB5_PRINCIPAL) &&
        ...
        return new SSPINameElement(principalName, gssNameStr, gssNameType);
    }

    static SSPINameElement getInstance(PrincipalName principalName) {
        return new SSPINameElement(principalName,
    ...
    public boolean equals(GSSNameSpi other) throws GSSException {
        ...
        if (other instanceof SSPINameElement) {
                SSPINameElement that = (SSPINameElement) other;
    ...
    public boolean equals(Object another) {
        ...
        try {
            if (another instanceof SSPINameElement)
                 return equals((SSPINameElement) another);
    ...
    public Oid getMechanism() {
        return (GSSUtil.GSS_KRB5_MECH_OID);
    }
